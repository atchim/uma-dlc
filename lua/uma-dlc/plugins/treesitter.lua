...
local function config_21(_, opts0)
...
return {{"JoosepAlviste/nvim-ts-context-commentstring", event = "BufRead", dependencies = "nvim-treesitter"}, {"nvim-treesitter/nvim-treesitter", cmd = {"TSInstall", "TSInstallSync", "TSInstallInfo", "TSUpdate", "TSUpdateSync", "TSUninstall", "TSModuleInfo", "TSEditQuery", "TSEditQueryUserAfter"}, event = "BufRead", opts = opts, config = config_21}, {"nvim-treesitter/nvim-treesitter-textobjects", event = "BufRead", dependencies = "nvim-treesitter"}, {"nvim-treesitter/playground", event = "BufRead", keys = {{"<Leader>tp", "<Cmd>TSPlaygroundToggle<CR>", desc = "Tree-Sitter Playground"}}, dependencies = "nvim-treesitter"}}
