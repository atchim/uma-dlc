...
( (let_clause . ((_) . (_))* . (_) @-start . (_) @-end)
  (#make-range! "swappable" @-start @-end))

;;;;;;;;;
;; List ;
;;;;;;;;;

((list . (symbol) @_symbol (_) @swappable) (#not-eq? @_symbol "macro"))
...
( (table . ([":" (_)] . (_))* . [":" (_)] @-start . (_) @-end)
  (#make-range! "swappable" @-start @-end))

( (quoted_table . ((_) . (_))* . (_) @-start . (_) @-end)
  (#make-range! "swappable" @-start @-end))

( (table_binding . ([":" (_)] . (_))* . [":" @-start (_) @-start] . (_) @-end)
  (#make-range! "swappable" @-start @-end))